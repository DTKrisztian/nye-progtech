...
public class SecondBoat extends Box {
    int xcord;
    int ycord;

    /**
     * Second boat handler for length, cords and who owns it currently and vertical check.
     */

    public SecondBoat(int x, int y, int whoOwn, boolean isVertical) {
        this.xcord = x;
        this.ycord = y;
        this.setLength(2);
